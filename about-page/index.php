...
<body>
    <header class="px-10 py-2 bg-header flex justify-between items-center">
        ...
        <nav class="flex items-center font-regular gap-16 font-medium text-lg">
            ...
            <a class="px-5 py-1 hover:bg-[#ef4a59] hover:animate-pulse transition rounded" href="../reservation">Reservation</a>
        ...
        <div class="relative size-fit">
            ...
            <div id="popoverContent" class="absolute hidden bg-background border border-white-300 rounded-lg shadow-lg px-4 py-2 space-y-2">
    ...
    <section class="container mx-auto mt-10 px-6">
        ...
        <div class="max-w-4xl mx-auto text-center text-white-700">
            <p class="text-lg leading-relaxed mb-6">
                Welcome to <strong>ComfyCorners</strong>, your go-to destination for luxurious, cozy, and affordable accommodations.
                Whether you're planning a weekend getaway or a long-term stay, we offer a wide range of rooms designed to meet your unique needs.
            </p>
            <p class="text-lg leading-relaxed mb-6">
                Our mission is to provide an exceptional hospitality experience with comfort, style, and convenience.
                At ComfyCorners, we believe in making every stay a memorable one. With carefully curated interiors and top-notch amenities,
        ...
        <div class="mt-10">
            ...
            <div class="flex flex-col md:flex-row items-center gap-8">
                <img src="../src/images/businessman.jpg" alt="CEO of ComfyCorners" style="max-width: 300px; width: 100%; height: auto;" class="rounded-lg shadow-md">
                <div class="text-center md:text-left">
                    <h3 class="text-2xl font-bold mb-2">John Doe</h3>
                    <p class="text-lg leading-relaxed text-white-700">
                        John Doe, the visionary CEO of ComfyCorners, brings years of experience in hospitality and a passion for excellence. 
                        Under his leadership, ComfyCorners has grown into a trusted name in the industry, recognized for unparalleled comfort 
                        and customer satisfaction. John’s commitment to innovation and personalized service ensures that every guest feels valued.
                    </p>
                </div>
            </div>
        </div>  
